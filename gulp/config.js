...
const ASSETS_VENDOR = join(ASSETS_DIR, 'vendor');
const ASSETS_VIDEOS = join(ASSETS_DIR, 'videos');
...
const STATIC_VENDOR = join(STATIC_DIR, 'vendor');
const STATIC_VIDEOS = join(STATIC_DIR, 'videos');
